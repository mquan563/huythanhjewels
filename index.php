...
<body>
    ...
    <section class="contentMedia">
        <div class="contentMedia__wrapper">
            ...
            <article class="contentMedia__text">
                ...
                <p class="contentMedia__description">Lấy tầm nhìn trở thành “Nhà bán lẻ trang sức dẫn đầu xu hướng", trang sức Huy Thanh mang phong cách trẻ trung, hiện đại, liên tục cập nhật những xu hướng mới từ Hàn Quốc. Ba dòng sản phẩm chủ lực của Huy Thanh Jewelry gồm có: Nhẫn cưới, Trang sức cưới và Trang sức hiện đại cho nữ giới. Khách hàng sở hữu trang sức vàng từ Huy Thanh Jewelry đồng thời sở hữu xu hướng mới nhất đến từ thế giới, được thể hiện bằng sản phẩm mang tính sáng tạo, đột phá trong thiết kế và công nghệ chế tác.</p>
    ...
    <section class="contentMedia right">
        <div class="contentMedia__wrapper">
            ...
            <article class="contentMedia__text">
                ...
                <p class="contentMedia__description">Mỗi sản phẩm, giao dịch tại Huy Thanh đều cam kết minh bạch, đầy đủ hoá đơn cho toàn bộ giao dịch. Huy Thanh mang đến dịch vụ chăm sóc và hậu mãi trọn đời với những đặc quyền hấp dẫn để khách hàng có thể có trải nghiệm mua sắm trọn vẹn nhất.</p>
                <div class="ctaContainer">
                    <a href="intro.php" class="button noMargin">Xem thêm</a>
                </div>
            </article>
    ...
    <div class="wrapper chatbox">
        <div class="title">Chatbot trực tuyến</div>
        <div class="form">
        ...
        <div class="typing-field">
            <div class="input-data">
                <input id="data" type="text" placeholder="Nhập một cái gì đó ở đây .." required>
